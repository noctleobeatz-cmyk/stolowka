...
function renderujStatus() {
    ...
    if (!zebrane || !zebrane.dania || zebrane.dniZDanymi === 0) {
        kontener.innerHTML = `
    ...
    const spelnioneRyba = liczRyba >= 1;
    const spelnioneWarzywo = zebrane.dniZWarzywem >= zebrane.dniZDanymi;

    const wszystkoOk = spelnioneMieso && spelnioneZupa && spelnioneRoslinne && spelnioneWarzywo && spelnioneRyba;
    ...
    const znaczniki = [
        ...
        [spelnioneRyba, `Ryba: ${liczRyba}/min. 1`],
